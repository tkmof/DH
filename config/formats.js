	...
	}, 
	{
		...
		onSwitchIn: function(pokemon) {
			...
			switch(name){
				...
				break;
				case 'mizuhime': case 'kalalokki': case 'sweep':
			...
			switch(name) {
				...
				case 'joim':
					...
					if (dice === 1) {
							...
							this.add('c|~Joim|' + sentences[this.random(8)]);
					}
					break;
				case 'juanma':
				...
				case 'zebraiken':
					...
					sentences = ["o_o", "*_*", "n_n"];
					this.add('c|&Zebraiken|bzzt ' + sentences[pokemon.phraseIndex]);
					break;
				case 'zeroluxgiven':
